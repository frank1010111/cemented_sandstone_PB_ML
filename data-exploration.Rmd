...
df <- readWorksheetFromFile("data/Garn1990.xlsx", sheet = 1) %>%
  ...
  ## Replace zeros in interparticle porosity and cement content to a 
  # value below the lowest measurable quantity
  mutate(
...
data <- merge(
  melt(shaps$shap_contrib, value.name = "SHAP"),
